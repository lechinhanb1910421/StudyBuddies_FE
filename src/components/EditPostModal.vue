...
<template>
  <div class="modal modal-lg fade" id="editPostModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header text-center">
          <h1 class="modal-title fs-5 w-100" id="modal_title">Editing your post</h1>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary btn_add_post" @click="submitEditPostForm">Post</button>
        </div>
      </div>
    </div>
  </div>
